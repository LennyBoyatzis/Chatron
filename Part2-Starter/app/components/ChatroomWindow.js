    ...
    return (
      <div className="form-group chatroom-window">
        ...
        <div className="form-group chatroom-content">
          ...
          <div className="bubble you">Yeah not too bad, glad it is the weekend. What you doing this weekend?</div>
          <div className="bubble me">Weather is great so I will probably head to the beach</div>
        </div>
        <div className="input">
